...
namespace MatterHackers.MatterCadGui
{
    public class DemoProjects
    {
        ...
        public static CsgObject PowerSupply()
        {
    ...
    {
        public static CsgObject Assembly()
        {
          ...
          //  OpenSCadOutput.Save(onOffArm, "up-down-bar.scad");
            ...
            return bedLevelMountMount;
        }

        public static void BedLevelTestCode()
        {
        ...
        public static CsgObject OnOffArm()
        {
            CsgObject total;
        ...
        public static CsgObject BedLevelMount()
        {
