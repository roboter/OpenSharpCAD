...
namespace SimplePartScripting
{
    static class SimplePartTester
    {
        ...
        static CsgObject SpoolBarHolderM90()
        {
            ...
            CsgObject attachHole = new Cylinder(attacheHoleDiameter/2, wallWidth + .2, 2);
            ...
            spoolHold -= new Align(new Cylinder(rodDiameter / 2, wallWidth + 2, 2), Face.Top, spoolHold, Face.Top);
